...
> 正所谓前人栽树，后人乘凉,非常感谢 伯荧（<a>http://qiubaiying.top</a>）同学的辛苦付出，能帮助更多同学快速搭建自己的个人博客主页，谢谢！
> 
> [我的的博客](http://maping.tech)

# 前言
从 Jekyll 到 GitHub Pages 中间踩了许多坑，终于把我的个人博客[BY Blog](http://maping.tech)搭建出来了。。。
...
> 很对人反映 Disqus 评论插件加载不出来，因为 Disqus 在国内加载缓慢，所以我新集成了 Gitalk 评论插件（感谢[@FeDemo](https://github.com/FeDemo)的推荐），喜欢折腾的朋友可以看这篇：[《为博客添加 Gitalk 评论插件》](http://maping.tech/2017/12/19/%E4%B8%BA%E5%8D%9A%E5%AE%A2%E6%B7%BB%E5%8A%A0-Gitalk-%E8%AF%84%E8%AE%BA%E6%8F%92%E4%BB%B6/)。 我已经在`_config.yml` 配置就好了，只需要填写参数可以了。
...
搭建好博客之后 你可能不想直接使用 [baiyingqiu.github.io](http://baiyingqiu.github.io) 这么长的博客域名吧, 想换成想 [maping.tech](http://maping.tech) 这样简短的域名。那我们开始吧！
...
用**阿里云** app也可以注册域名，域名的价格根据后缀的不同和域名的长度而分，比如我这个 `maping.tech` 的域名第一年才只要4元~
...
一个主机记录为 `www`,代表可以解析 `www.maping.tech`的域名
